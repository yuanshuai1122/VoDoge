...
func callbackHTML() string {
	return `<!doctype html><html><body><script>try{window.parent.postMessage({type:"vohive-websheet-callback"},"*")}catch(_){}</script>Carrier flow returned to VoDoge.</body></html>`
}
